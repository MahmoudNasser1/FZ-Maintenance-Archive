...
api_router.include_router(cases.batch_router, prefix="/cases/batch", tags=["cases", "batch-operations"])
api_router.include_router(cases.stats_router, prefix="/cases/stats", tags=["cases", "statistics"])
