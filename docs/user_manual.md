...
4. يمكنك مسح رمز QR لحالة بالنقر على زر "مسح رمز QR" للوصول السريع للحالة.
...
3. قسم QR Code: في صفحة التفاصيل، يمكنك النقر على زر "انشاء QR Code" لتوليد رمز QR يحتوي على معلومات الحالة.
...
### استخدام رموز QR للحالات

#### إنشاء ومشاركة رمز QR لحالة

1. في صفحة تفاصيل الحالة، انقر على زر "انشاء QR Code" الموجود بالقرب من معلومات الحالة.
2. سيظهر مربع حوار يحتوي على رمز QR للحالة مع الخيارات التالية:
   - **مشاركة**: لمشاركة رمز QR مع الآخرين.
   - **تنزيل**: لحفظ صورة رمز QR على جهازك.
   - **طباعة**: لطباعة رمز QR مباشرة.
3. يحتوي رمز QR على معلومات شاملة عن الحالة بما في ذلك رقم الحالة، معلومات الفني، ومعلومات العميل.

#### مسح رمز QR لحالة

1. في صفحة قائمة الحالات، انقر على زر "مسح رمز QR" الموجود في أعلى الصفحة.
2. سيظهر مربع حوار مع ماسح الكاميرا لرمز QR.
3. قم بتوجيه كاميرا الجهاز نحو رمز QR للحالة.
4. بمجرد تم مسح الرمز بنجاح، سيتم توجيهك تلقائيًا إلى صفحة تفاصيل الحالة المطلوبة.
5. يمكن استخدام هذه الميزة للوصول السريع لتفاصيل الحالة عند العمل ميدانيًا.
